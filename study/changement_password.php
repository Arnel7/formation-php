    ...
    if($_POST["token"]==$_SESSION["csrf_token"]){
        ...
        if($_POST["pwd1"]==$_POST["pwd2"]){
           ...
           // $code=random_int(100000,999999);
            ...
            $infosUser=$users->updatePassword($_SESSION["email"],$password);
          ...
          <div class="modal-content rounded-4 shadow">
            ...
            <div style="background: transparent;" class="modal-body p-5 pt-0">
              <form method="post" class="">
                <h2 style="text-align: center; margin-top: 4%; font-size: 32px; font-weight: bold;">changement password</h2>
                <p class="titre-form">Remplissez le formulaire pour changer <br> votre mot de passe</p>
                <p style="color:red;"  ><?php   if(isset($erreur)){echo $erreur;}  ?></p>
                <div class="form-floating mb-3">
                  <input type="password"  name="pwd1" class="form-control rounded-3" id="floatingInput" placeholder="password">
				  <input type="hidden" name="token" value="<?php echo $_SESSION["csrf_token"]; ?>">
                  <label for="floatingInput">Nom d'utilisateur ou email</label>
                </div>

                <div class="form-floating mb-3">
                  <input type="password"  name="pwd2" class="form-control rounded-3" id="floatingInput" placeholder="password">
