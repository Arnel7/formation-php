...
if($_SERVER['REQUEST_METHOD']=="POST"){
        ...
        if($_POST["code"]==$_SESSION["code"]){
            header("location:changement_password.php");
        }
          ...
          <div class="modal-content rounded-4 shadow">
            ...
            <div style="background: transparent;" class="modal-body p-5 pt-0">
              <form method="post" class="">
                <h2 style="text-align: center; margin-top: 4%; font-size: 32px; font-weight: bold;">Code de vérification</h2>
                <p class="titre-form">Entrez votre le code recu par email<br> </p>
                <div class="form-floating mb-3">
                  <input type="text"  name="code" class="form-control rounded-3" id="floatingInput" placeholder="code ">
