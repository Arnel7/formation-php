...
if($_SERVER['REQUEST_METHOD']=="POST"){
	...
	if(filter_var($_POST["email"],FILTER_VALIDATE_EMAIL)){
		...
		if($_POST["token"]==$_SESSION["csrf_token"]){
			$users=new Users($bdd);
			$connexion=$users->connexion($_POST["email"],$password);
			...
			if($connexion){
				...
				$erreur="les idantifiants sont incorrects";
          ...
          <div class="modal-content rounded-4 shadow">
            ...
            <div style="background: transparent;" class="modal-body p-5 pt-0">
              <form method="POST"  class="">
                <h2 style="text-align: center; margin-top: 4%; font-size: 32px; font-weight: bold;">Se connecter</h2>
                <p class="titre-form">Vous n'avez pas de compte ?  <a style="text-decoration: none;" href="signup.html">S'identifier</a></p>
				<h3><?php   if(isset($erreur)){echo $erreur;}  ?></h3>
				<div class="form-floating mb-3">
                  <input type="email" name="email" class="form-control rounded-3" id="floatingInput" placeholder="Nom d'utilisateur">
                ...
                <input style="margin-bottom: 2%;" class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                  <label class="form-check-label" for="flexCheckDefault">
                      Se souvenir
                  </label>
                  <a style="text-decoration: none; margin-bottom: 2%;" href="password_oublie.html">Mot de passe oublié</a>
